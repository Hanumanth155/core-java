...
for (String kannadaMovieName : kannadaMovies) {
    System.out.println(kannadaMovieName);
}

System.out.println("\nHindi Movies:");
for (String hindiMovieName : hindiMovies) {
    System.out.println(hindiMovieName);
}

System.out.println("\nEnglish Movies:");
for (String englishMovieName : englishMovies) {
    System.out.println(englishMovieName);
}

System.out.println("\nTamil Movies:");
for (String tamilMovieName : tamilMovies) {
    System.out.println(tamilMovieName);
}

System.out.println("\nTelugu Movies:");
for (String teluguMovieName : teluguMovies) {
